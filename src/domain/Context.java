...
public class Context {
    ...
    public void guardarPaciente(Paciente paciente) {
    	try(BufferedWriter bw = new BufferedWriter(new FileWriter("resources/data/pacientes.csv",true))){
    ...
    public void guardarCama(Cama cama) {
    	try(BufferedWriter bw = new BufferedWriter(new FileWriter("resources/data/camas.csv",true))){
    		StringBuilder linea = new StringBuilder();
    ...
    public void guardarHistorial(Paciente paciente, Historial historial) {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("resources/data/pacientes.csv", false))) { 
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");

...
public class ProgressBar extends JFrame {
    ...
    public ProgressBar(Persona usuario ,Boolean p) {
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/db/Hospital.png")); // Replace with your icon path
    ...
    private class Counter extends Thread {
        ...
        public void run() {
            ...
            while (count <= 100 && !Thread.currentThread().isInterrupted()) {
                ...
                if (count >= 0 && count <= 33) {
                    label.setText("Cargando Medicos");
                } else if (count >= 34 && count <= 66) {
                    label.setText("Cargando Citas");
                } else if (count >= 67 && count < 100) {
                    label.setText("Cargando Pacientes");
                } else if (count == 100) {
